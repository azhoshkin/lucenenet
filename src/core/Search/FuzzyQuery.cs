...
namespace Lucene.Net.Search
{
    ...
    public class FuzzyQuery : MultiTermQuery
    {
        ...
        public FuzzyQuery(Term term, float minimumSimilarity, int prefixLength)
        {
            ...
            maxEdits = SingleToEdits(minimumSimilarity, term.Text.Length);

            if (maxEdits < 0 || maxEdits > 2)
                throw new System.ArgumentException("maxEdits must be between 0 and " + 2);
        ...
        public FuzzyQuery(Term term):this(term, defaultMaxEdits, defaultPrefixLength)
        {
        }
        ...
        {
            return new FuzzyTermEnum(reader, Term, maxEdits, prefixLength);
        }
        ...
        public override System.String ToString(System.String field)
        {
            ...
            buffer.Append('~');
            buffer.Append(maxEdits.ToString(CultureInfo.InvariantCulture));
        ...
        public override int GetHashCode()
        {
            ...
            result = prime * result + BitConverter.ToInt32(BitConverter.GetBytes(maxEdits), 0);
        ...
        public  override bool Equals(System.Object obj)
        {
            ...
            if (BitConverter.ToInt32(BitConverter.GetBytes(maxEdits), 0) != BitConverter.ToInt32(BitConverter.GetBytes(other.maxEdits), 0))
                return false;
        ...
        {
            if ((double)minimumSimilarity >= 1.0)
                return (int)Math.Min(minimumSimilarity, 2f);
            return (double)minimumSimilarity == 0.0 ? 0 : Math.Min((int)((1.0 - (double)minimumSimilarity) * (double)termLen), 2);
        }
    }
}